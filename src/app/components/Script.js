import { UIElement, UIPanel, UIText } from '@src/app/libs/ui.js';
import { CodeMirror } from 'codemirror';
import { esprima } from 'esprima';
import { jsonlint } from 'jsonlint';

import { SetScriptValueCommand } from '@src/app/editor/commands/SetScriptValueCommand.js';
import { SetMaterialValueCommand } from '@src/app/editor/commands/SetMaterialValueCommand.js';
		...
		return codemirror.operation( function () {
			...
			switch ( currentMode ) {
				...
				case 'json':
					...
					jsonlint.jsonlint.parseError = function ( message, info ) {
					...
					try {
						...
						jsonlint.jsonlint.parse( string );
