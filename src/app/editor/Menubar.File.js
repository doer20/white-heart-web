...
import { UIPanel, UIRow, UIHorizontalRule } from '@src/app/libs/ui.js';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		var { ColladaExporter } = await import( 'three/examples/jsm/exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		var { DRACOExporter } = await import( 'three/examples/jsm/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		var { GLTFExporter } = await import( 'three/examples/jsm/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		var { OBJExporter } = await import( 'three/examples/jsm/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		var { PLYExporter } = await import( 'three/examples/jsm/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		var { STLExporter } = await import( 'three/examples/jsm/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		var { USDZExporter } = await import( 'three/examples/jsm/exporters/USDZExporter.js' );
